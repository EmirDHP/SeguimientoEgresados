...
namespace SeguimientoEgresados.Models
{
    public class PreguntasModelo
    {
        ...
        [DisplayName("Dirección de correo electrónico personal")]
        ...
        [DisplayName("2. ¿Cuántos trabajos has tenido desde que egresaste de la UT?")]
        ...
        [DisplayName("22. Aconsejarías a un familiar o amigo estudiar en la UT?")]
        ...
        [Required(ErrorMessage = "Please enter marks")]
        [DisplayName("Año en que comenzo")]
